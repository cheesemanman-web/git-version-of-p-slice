...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PSliceEngine", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("PSliceEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "342";
		app.meta["company"] = "mikolka9144";
		app.meta["file"] = "PSliceEngine";
		app.meta["name"] = "Friday Night Funkin': P-Slice Engine";
		app.meta["packageName"] = "com.mikolka9144.pslice";
		app.meta["version"] = "3.4.2";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': P-Slice Engine",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Friday Night Funkin': P-Slice Engine";
		#else
